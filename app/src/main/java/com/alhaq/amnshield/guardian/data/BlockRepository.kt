...
class BlockRepository private constructor(private val db: LocalDatabase) {
    ...
    suspend fun saveBlock(block: Block) = withContext(Dispatchers.IO) {
        ...
        val (validDomains, domainErrors) = com.alhaq.amnshield.guardian.util.BlockUtils.validateDomainList(
        ...
        val (validKeywords, keywordErrors) = com.alhaq.amnshield.guardian.util.BlockUtils.validateKeywordList(
