...
private fun QuickTemplatesCard() {
    Card(
        ...
        Column(
            ...
            listOf(
                FocusTemplate("Deep Work", "90 min", "ðŸ“š"),
                FocusTemplate("Quick Focus", "25 min", "âš¡"),
                FocusTemplate("Study Mode", "60 min", "ðŸŽ“"),
                FocusTemplate("Break Time", "10 min", "â˜•")
            ).forEach { template ->
...
private fun SessionHistoryCard() {
    Card(
        ...
        Column(
            ...
            listOf(
                SessionHistoryItem("Today", "Deep Work", "90 min", "âœ“ Completed", Color(0xFF16A34A)),
                SessionHistoryItem("Yesterday", "Study Mode", "60 min", "âœ“ Completed", Color(0xFF16A34A)),
                SessionHistoryItem("2 days ago", "Quick Focus", "25 min", "âŠ— Interrupted", Color(0xFFEAB308))
            ).forEach { item ->
...
private fun FocusModeTipsCard() {
    Card(
        ...
        Column(
            ...
            Text(
                text = "â€¢ Start with 25-minute sessions (Pomodoro technique)",
                fontSize = 13.sp,
                color = Color(0xFF4B5563)
            )
            Text(
                text = "â€¢ Take 5-minute breaks between sessions",
                fontSize = 13.sp,
                color = Color(0xFF4B5563)
            )
            Text(
                text = "â€¢ Close notifications during focus mode",
                fontSize = 13.sp,
                color = Color(0xFF4B5563)
            )
            Text(
                text = "â€¢ Track your progress in the Reports tab",
                fontSize = 13.sp,
                color = Color(0xFF4B5563)
            )
        }
