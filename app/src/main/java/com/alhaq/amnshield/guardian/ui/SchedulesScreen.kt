...
private fun QuickScheduleTemplatesCard() {
    Card(
        ...
        Column(
            ...
            listOf(
                ScheduleTemplate("School Hours", "9:00 AM - 3:00 PM", "ðŸ“š", listOf("Mon", "Tue", "Wed", "Thu", "Fri")),
                ScheduleTemplate("Sleep Time", "10:00 PM - 6:00 AM", "ðŸ˜´", listOf("Every Day")),
                ScheduleTemplate("Work Hours", "9:00 AM - 5:00 PM", "ðŸ’¼", listOf("Mon", "Tue", "Wed", "Thu", "Fri")),
                ScheduleTemplate("Family Time", "6:00 PM - 8:00 PM", "ðŸ‘¨â€ðŸ‘©â€ðŸ‘§", listOf("Every Day"))
            ).forEach { template ->
...
private fun ScheduleItem(schedule: ActiveSchedule) {
    ...
    Row(
        ...
        Column(
            ...
            Text(
                text = "${schedule.time} â€¢ ${schedule.days}",
                fontSize = 12.sp,
                color = Color(0xFF6B7280)
            )
        }
