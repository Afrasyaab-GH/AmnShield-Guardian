...
import org.alhaq.deenshield.guardian.ui.*
import org.alhaq.deenshield.guardian.ui.schedule.WeeklyScheduleScreen
import org.alhaq.deenshield.guardian.ui.theme.BlockerTheme
import org.alhaq.deenshield.guardian.viewmodel.BlockViewModel
import com.deenshield.blocker.ui.auth.IdentityModeScreen
...
@Composable
fun GuardianApp(vm: BlockViewModel = viewModel()) {
...
fun PremiumScreen(navController: NavHostController) {
    Column(
        ...
        // Pricing options
        PricingCard("Lifetime", "£13.50", "One-time purchase", true)
        PricingCard("Yearly", "£2.50/month", "Billed annually £30", false)
        PricingCard("Monthly", "£3.50/month", "Cancel anytime", false)
