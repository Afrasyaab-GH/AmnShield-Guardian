package org.alhaq.deenshield.guardian.network

import org.alhaq.deenshield.guardian.util.BlockLists
 ...
 * Thread-safe singleton for concurrent access from VPN and UI threads
 */
@Singleton
