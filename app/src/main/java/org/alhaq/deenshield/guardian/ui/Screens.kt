...
import org.alhaq.deenshield.guardian.ui.components.ToggleItem
...
@Composable
private fun AppRuleCard(rule: org.alhaq.deenshield.guardian.model.AppRule, onUpdate: (org.alhaq.deenshield.guardian.model.AppRule) -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
...
internal fun isVpnServiceActive(ctx: android.content.Context): Boolean {
...
internal fun isAccessibilityServiceEnabled(ctx: android.content.Context): Boolean {
    val expectedComponentName = "org.alhaq.deenshield.guardian/org.alhaq.deenshield.guardian.service.AccessibilityBlocker"
